package com.saucelabs.automation.testbase;
...
import com.saucelabs.automation.extentreport.Extent;
import com.saucelabs.automation.logreports.LogReporter;
...
public class TestBase extends Extent{
	...
	public void baseSetup() throws IOException, InstantiationException, IllegalAccessException {
		...
		String[] chooser=System.getProperty("webdrivername").split(",");
